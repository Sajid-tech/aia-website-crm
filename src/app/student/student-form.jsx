      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3  lg:grid-cols-4  gap-4">
          <div>
            ...
            />
            {errors.student_uid && (
              <p className="text-xs text-red-500 mt-1">{errors.student_uid}</p>
            )}
          </div>
          ...
          <div>
            ...
            />
            {errors.student_sort && (
              <p className="text-xs text-red-500 mt-1">{errors.student_sort}</p>
            )}
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4   gap-4">
          ...
          <div>
            ...
            <Select
              ...
              onValueChange={(v) =>
                setData({ ...data, student_have_youtube: v })
              }
            >
              <SelectTrigger>
                <SelectValue />
